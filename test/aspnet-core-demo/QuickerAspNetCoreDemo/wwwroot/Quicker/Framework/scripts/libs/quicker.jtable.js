...
(function ($) {
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        //Override _create function to change actions according to Quicker system
        _create: function () {
            var self = this;
            base._create.apply(self, arguments);

            if (self.options.actions.listAction) {
                self._adaptListActionforQuicker();
            }

            if (self.options.actions.createAction) {
                self._adaptCreateActionforQuicker();
            }

            if (self.options.actions.updateAction) {
                self._adaptUpdateActionforQuicker();
            }

            if (self.options.actions.deleteAction) {
                self._adaptDeleteActionforQuicker();
            }
        },

        //LIST ACTION ADAPTER
        _adaptListActionforQuicker: function () {
            var self = this;
            ...
            self.options.actions.listAction = function (postData, jtParams) {
                return $.Deferred(function ($dfd) {
                    ...
                    originalListAction.method(input)
                        ...
                        .fail(function (error) {
                            self._handlerForFailOnQuickerRequest($dfd, error);
                        });
                });
            };
        },
        ...
        _adaptCreateActionforQuicker: function () {
            var self = this;
        ...
        _adaptUpdateActionforQuicker: function () {
            var self = this;
        ...
        _adaptDeleteActionforQuicker: function () {
            var self = this;
        ...
        _handlerForFailOnQuickerRequest: function ($dfd, error) {
        ...
        _showError: function (message) {
            //do nothing since Quicker handles error messages!
        }
